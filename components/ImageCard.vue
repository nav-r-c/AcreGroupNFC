<template>
    <div class = "mx-auto text-center font-[Roboto] border-b-2 py-5 text-[#1E2968]">
        <img :src = "props.imageLink" alt = "Place" class = "w-[80%] mx-auto rounded-md" />
        ...
        <p class = "w-[80%] mx-auto">{{ props.description }}</p>
